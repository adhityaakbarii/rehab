						...
						<div class="card">
							<form class="form-horizontal" action="proses/pasca_rehabilitas/<?php echo $form ?>" method="POST" enctype="multipart/form-data">
								<div class="card-header">
									<h5>Program Pasca Rehabilitas</h5>
								</div>
								<div class="card-body">								
									...
									<div class="form-group row">
										<div class="col-sm-12">
											<label for="fname" class="col-sm-3 text-left control-label col-form-label">4. Pertemuan</label>
											<label for="fname" class="col-sm-1 text-right control-label col-form-label">:</label>
									...
									<div class="form-group row">
										<div class="col-sm-12">
											<label for="fname" class="col-sm-10 text-left control-label col-form-label">5. Fisik Evaluasi</label>
											<table class="table table-hover table-bordered">
												<thead>
													<tr>
														<td width="400" align="center"> Nilai </td>
														<td>
										...
										<div class="form-group row">
											<div class="col-sm-12">
												<label for="fname" class="col-sm-10 text-left control-label col-form-label">6. Psikologis Evaluasi</label>
												<table class="table table-hover table-bordered">
													<thead>
														<tr>
															<td width="400" align="center"> Nilai </td>
											...
											<div class="form-group row">
												<div class="col-sm-12">
													<label for="fname" class="col-sm-10 text-left control-label col-form-label">7. Sosial Evaluasi</label>
													<table class="table table-hover table-bordered">
														<thead>
															<tr>
																<td width="400" align="center"> Nilai </td>
												...
												<div class="form-group row">
													<div class="col-sm-12">
														<label for="fname" class="col-sm-10 text-left control-label col-form-label">8. Lingkungan Evaluasi</label>
														<table class="table table-hover table-bordered">
															<thead>
																<tr>
																	<td width="400" align="center"> Nilai </td>
													...
													<div class="form-group row">
														<label for="fname" class="col-sm-3 text-left control-label col-form-label">9. Catatan Petugas Pascarehabilitas</label>
														<div class="col-sm-9">
															<textarea class="form-control" <?php $read ?> value="<?php echo $tampil = ($row!='')? $row->nama_assesmen : "";?>" name="nama_assesmen" class="form-control" placeholder="">
															</textarea>
														</div>
													...
													<div class="form-group row">
														<label for="fname" class="col-sm-12 text-right control-label col-form-label"><a href="proses/pertemuan_kelompok/add"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Sebelumnya</a></label>
													</div>
