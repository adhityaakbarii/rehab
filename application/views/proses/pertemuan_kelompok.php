							...
							<form class="form-horizontal" action="proses/pertemuan_kelompok/<?php echo $form ?>" method="POST" enctype="multipart/form-data">
								...
								<div class="card-body">								
									...
									<div class="form-group row" style="margin-left: 1px;">
										<label for="fname" class="col-sm-3 text-left control-label col-form-label">5. Alamat Pertemuan</label>
										<label for="fname" class="col-sm-1 text-right control-label col-form-label">:</label>
										<div class="col-sm-8">
									...
									<div class="form-group row" style="margin-left: 1px;">
										<label for="fname" class="col-sm-3 text-left control-label col-form-label">9. Gambaran Perilaku Selama Pertemuan Kelompok</label>
										<div class="col-sm-9">
											<textarea class="form-control" <?php $read ?> value="<?php echo $tampil = ($row!='')? $row->nama_assesmen : "";?>" name="nama_assesmen" class="form-control" placeholder="">
											</textarea>
										</div>
									...
									<div class="form-group row">
										...
										<label for="fname" class="col-sm-6 text-right control-label col-form-label"><a href="proses/pertemuan_kelompok/add"> Selanjutnya <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></label>
									</div>
