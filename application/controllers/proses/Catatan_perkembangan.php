...
class Catatan_perkembangan extends CI_Controller {

	var $tables =   "rh_client";		
	var $page		="proses/catatan_perkembangan";
	var $pk     =   "id_client";
	var $title  =   "Catatan Perkembangan";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Proses</a></li>										
	<li class='breadcrumb-item active'><a href='trans/booking'>Data Catatan Perkembangan</a></li>										
	</ol>";				          
	...
	{								
		...
		$data['set']		= "view";		
		$data['mode']		= "view";				
		$data['dt_catatan_perkembangan'] = $this->db->query("SELECT * FROM rh_instansi");
		$this->template($data);	
	}
	public function add()
	{								
