...
class Pertemuan_kelompok extends CI_Controller {

	var $tables =   "rh_client";		
	var $page		="proses/pertemuan_kelompok";
	var $pk     =   "id_client";
	var $title  =   "Pertemuan Kelompok";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Proses</a></li>										
	<li class='breadcrumb-item active'><a href='trans/booking'>Data Pertemuan Kelompok</a></li>										
	</ol>";				          
	...
	{								
		...
		$data['set']		= "view";		
		$data['mode']		= "view";				
		$data['dt_pertemuan_kelompok'] = $this->db->query("SELECT * FROM rh_instansi");
		$this->template($data);	
	}
	public function add()
	{								
