...
class Client extends CI_Controller {
	...
	var $page		=		"proses/client";
	var $pk     =   "id_client";
	var $title  =   "Client";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Proses</a></li>										
	<li class='breadcrumb-item active'><a href='trans/booking'>Data Client</a></li>										
	</ol>";				          
	...
	{								
		...
		$data['set']		= "view";		
		$data['mode']		= "view";				
		$data['dt_client'] = $this->db->query("SELECT rh_client.*,rh_instansi.instansi,rh_staf.nama_lengkap FROM rh_client
			LEFT JOIN rh_instansi ON rh_client.id_instansi = rh_instansi.id_instansi
			LEFT JOIN rh_staf ON rh_staf.id_staf = rh_client.id_staf		
			ORDER BY rh_client.id DESC");
		$this->template($data);	
	}
	public function add()
	{								
