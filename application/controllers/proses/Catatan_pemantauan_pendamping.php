...
class Catatan_pemantauan_pendamping extends CI_Controller {

	var $tables =   "rh_client";		
	var $page		="proses/catatan_pemantauan_pendamping";
	var $pk     =   "id_client";
	var $title  =   "Catatan Pemantauan Pendamping";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Proses</a></li>										
	<li class='breadcrumb-item active'><a href='trans/booking'>Data Catatan Pemantauan Pendamping</a></li>										
	</ol>";				          
	...
	{								
		...
		$data['set']		= "view";		
		$data['mode']		= "view";				
		$data['dt_catatan_pemantauan_pendamping'] = $this->db->query("SELECT * FROM rh_instansi");
		$this->template($data);	
	}
	public function add()
	{								
